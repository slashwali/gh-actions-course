...
async function run() {
    ...
    const gitStatus = exec.getExecOutput('git status -s package*.json', [], {
        cwd: workingDir
    });
    ...
    [DONE]1. Parse Inputs
      ...
      1.2 Github Token for authentication purposes (to create {PRs)
      1.4 Working directory for which to check for dependencies
    2. Execut the npm update command within the working directorynpm
